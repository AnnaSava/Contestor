...
namespace Contestor.Migrations.PostgreSql.Contest
{
    ...
    [Migration("20210725092245_ContestFields")]
    partial class ContestFields
    {
            ...
            modelBuilder.Entity("Contestor.Data.Entities.Work", b =>
                {
                    ...
                    b.Property<long?>("ParticipantContestId")
                        .HasColumnType("bigint")
                        .HasColumnName("participant_contest_id");
                    ...
                    b.HasIndex("ParticipantUserId", "ParticipantContestId")
                        .HasDatabaseName("ix_works_participant_user_id_participant_contest_id");
            ...
            modelBuilder.Entity("Contestor.Data.Entities.Work", b =>
                {
                    ...
                    b.HasOne("Contestor.Data.Entities.Participant", "Participant")
                        .WithMany("Works")
                        .HasForeignKey("ParticipantUserId", "ParticipantContestId")
