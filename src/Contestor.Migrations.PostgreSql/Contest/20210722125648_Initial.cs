        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    process_key = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_participants", x => new { x.user_id, x.contest_id });
                    table.ForeignKey(
                        name: "fk_participants_contests_contest_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    participant_user_id = table.Column<long>(type: "bigint", nullable: true),
                    participant_contest_id = table.Column<long>(type: "bigint", nullable: true),
                    contest_id = table.Column<long>(type: "bigint", nullable: false),
                    title = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_works_contests_contest_id",
                        column: x => x.contest_id,
                        principalTable: "contests",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        columns: x => new { x.participant_user_id, x.participant_contest_id },
            ...
            migrationBuilder.CreateIndex(
                name: "ix_participants_contest_id",
                table: "participants",
                column: "contest_id");

            migrationBuilder.CreateIndex(
                name: "ix_works_contest_id",
                table: "works",
                column: "contest_id");
